      ...
      <ScrollView className="flex-1 px-4 py-6">
        <View className="relative bg-white shadow-lg">
          ...
          <View className="absolute flex-row inset-x-0 top-5 justify-between px-6">
            ...
            >
              <FontAwesome5 name="chevron-left" size={24} color="#00ACC1" />
            </TouchableOpacity>

            <TouchableOpacity className="w-10 h-10 rounded-md items-center justify-center bg-cyan-400">
        ...
        <View className="mt-4 flex-row items-center justify-between">
          {data?.rating && (
            <View className="flex-row items-center space-x-2">
              <View className="w-12 h-12 rounded-2xl bg-red-100 items-center justify-center shadow-md">
                <FontAwesome name="star" size={24} color="#f5e042" />
              </View>
              <View>
          ...
          {data?.bearing && (
            <View className="flex-row items-center space-x-2">
              <View className="w-12 h-12 rounded-2xl bg-red-100 items-center justify-center shadow-md">
                <FontAwesome name="map-signs" size={24} color="#f5e042" />
              </View>
              <View>
